...
set -e  # Exit on error
# ============================================================================
# Configuration & Arguments (LITE VERSION)
# ============================================================================
# Model configuration
...
DOCKER_IMAGE="${DOCKER_IMAGE:-lmsysorg/sglang:v0.4.1-cu124}"
CONTAINER_NAME="${CONTAINER_NAME:-mkhalidm_sglang_lite}"
...
for spec in $TEST_SPECS; do
    ...
    sleep 2  # Brief cool down between scenarios
done
echo ""
echo "=========================================="
